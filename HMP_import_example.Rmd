...
```{r}
HMPv35.tree$tip.label <- substr(species.names(HMPv35.tree), 2, nchar(species.names(HMPv35.tree))-1)
```
...
```{r import-HMPv35}
system.time(HMPv35 <- import_qiime(temp_otutax, temp_map, HMPv35.tree, chunk.size=2000L))
```
